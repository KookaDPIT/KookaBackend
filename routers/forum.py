...
# Limbile în care se poate deschide un subforum. Lista e închisă intenționat:
# subforumurile trebuie să rămână puține și populate, nu una per utilizator.
LANGUAGES = [
...
def meta(db: Session = Depends(get_db)):
    ...
    return {
        "languages": [
            {**lang, "posts": int(lang_rows.get(lang["code"], 0) or 0)}
